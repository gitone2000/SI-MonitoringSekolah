...
<head>
    ...
    <style>
        ...
        .overlay {
            ...
            /* z-index: 1; Tambahkan z-index agar overlay tetap berada di atas konten */
        }
        .card{
            color: black;
        }
        .transparent-background {
            background-color: rgb(255, 255, 255); /* Adjust the last value (alpha) for opacity */
        }
        footer {
            position: fixed;
            bottom: 0;
...
<body>
<!-- Navbar -->
<nav class="navbar navbar-expand-lg bg-success animate__animated animate__fadeIn py-2">
  <div class="container">
    <a class="navbar-brand text-white" href="#"><b>APLIKASI MONITORING</b></a>
